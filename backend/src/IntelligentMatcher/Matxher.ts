...
// import { InputValidator } from "./safety/InputValidator";
...
//   maxInputLength: number; // Added missing property
//   enableSafetyFeatures: boolean; // Also add this if used in config
// }
...
//    */
//   // Replace the Levenshtein method in SimilarityAlgorithms class
...
//     // Find semantic group matches
//     for (const [group, words] of semanticGroups) {
...
//       maxInputLength: 1000, // New safety parameter
//       enableSafetyFeatures: true, // New safety parameter
//       ...config,
//     };
...
//       suggestedResponse: params.match
...
//     const features = TextPreprocessor.extractFeatures(userInput);

//     // Intent-based response generation
//     if (
//       features.questionWords.includes("what") &&
//       (normalized.includes("name") || normalized.includes("called"))
//     ) {
//       return {
//         suggestedKey: "what is your name",
//         suggestedResponse: "My name is Blaze.",
//       };
//     }

//     if (
//       features.questionWords.includes("who") &&
//       (normalized.includes("made") ||
//         normalized.includes("created") ||
//         normalized.includes("developed"))
//     ) {
//       return {
//         suggestedKey: "who developed you",
//         suggestedResponse:
//           "I was developed by a wonderful guy called Nabasa Amos",
//       };
//     }

//     if (features.questionWords.includes("how") && normalized.includes("are")) {
//       return {
//         suggestedKey: "how are you",
//         suggestedResponse: "I'm doing great, thank you! How are you doing?",
//       };
//     }

//     if (normalized.includes("joke") || normalized.includes("funny")) {
//       return {
//         suggestedKey: "tell me a joke",
//         suggestedResponse:
...
//     if (
//       features.actionVerbs.includes("help") ||
//       normalized.includes("assist")
//     ) {
//       return {
//         suggestedKey: "can you help me",
//         suggestedResponse:
...
//   /**
//    * Build debug scores object
//    */
//   private buildDebugScores(scoredCandidates: any[]): {
...
//   /**
//    * Get learning suggestions for frequently unmatched patterns
//    */
//   public getLearningInsights(): {
//     frequentUnmatched: Array<{
//       pattern: string;
//       frequency: number;
//       suggestion?: { key: string; response: string };
//     }>;
//     totalPatterns: number;
//     suggestionsCount: number;
//   } {
//     const frequentUnmatched = Array.from(this.learningPatterns.entries())
//       .filter(
//         ([_, pattern]) =>
//           pattern.frequency >= this.config.minFrequencyForSuggestion
//       )
//       .map(([key, pattern]) => ({
//         pattern: pattern.input,
//         frequency: pattern.frequency,
//         ...(pattern.suggestedKey &&
//           pattern.suggestedResponse && {
//             suggestion: {
//               key: pattern.suggestedKey,
...
//       suggestionsCount: frequentUnmatched.filter((p) => p.suggestion).length,
//     };
//   }
...
//     const needsRebuild =
//       newConfig.useNgrams !== oldConfig.useNgrams ||
//       newConfig.minNgramSize !== oldConfig.minNgramSize ||
//       newConfig.maxNgramSize !== oldConfig.maxNgramSize ||
//       newConfig.enableStemming !== oldConfig.enableStemming ||
//       newConfig.enableStopwordRemoval !== oldConfig.enableStopwordRemoval;
...
//   /**
//    * Add new custom responses and rebuild indexes
//    */
//   public addResponses(newResponses: CustomResponses): void {
//     this.customResponses = { ...this.customResponses, ...newResponses };
//     this.responseKeys = Object.keys(this.customResponses);
//     this.buildIndexes();
//   }

//   /**
//    * Remove responses and rebuild indexes
//    */
//   public removeResponses(keysToRemove: string[]): void {
//     for (const key of keysToRemove) {
//       delete this.customResponses[key];
//     }
//     this.responseKeys = Object.keys(this.customResponses);
//     this.buildIndexes();
//   }
...
//   } {
//     const memoryUsage =
//       (JSON.stringify(this.customResponses).length +
//         JSON.stringify(Array.from(this.preprocessedKeys)).length +
//         JSON.stringify(Array.from(this.ngramIndex)).length) /
//       1024; // KB

//     return {
//       totalResponses: this.responseKeys.length,
//       indexSize: this.ngramIndex.size,
//       memoryUsage,
//     };
//   }
...
//         if (result.match !== null) successCount++;
//       }
//     }
...
//   /**
//    * Export configuration and learned patterns
//    */
//   public exportState(): {
//     config: MatcherConfig;
//     responses: CustomResponses;
//     learningPatterns: Array<[string, LearningPattern]>;
...
//     if (state.responses) {
//       this.customResponses = state.responses;
//       this.responseKeys = Object.keys(this.customResponses);
//     }
...
//   }> {
//     if (!testCases) {
//       const responses = matcher.exportState().responses;
...
//     // Run tests
//     for (const testCase of testCases) {
//       const result = matcher.findBestMatch(testCase.input);
